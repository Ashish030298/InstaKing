package com.qnape.instaking.navigation;
...
public class CellImageView extends AppCompatImageView {
    ...
    public CellImageView(@NonNull Context context) {
        super(context);
        this.useColor = true;
    ...
    public CellImageView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.useColor = true;
        Context var10001 = this.getContext();
        this.size = Utils.dip(var10001, 24);
    ...
    public CellImageView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
